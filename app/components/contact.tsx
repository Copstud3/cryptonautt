...
export default function Contact() {
  ...
  return (
    <section className="px-5 md:px-20 md:h-[calc(100vh-60px)] relative max-sm:py-20 z-20" id="message">
      <div className="pb-10">
      ...
      <div className="flex justify-center items-center mt-5 md:mt-10">
        <form className="w-[700px] flex flex-col gap-10 font-inter" onSubmit={handleSubmit}>
          <div className="flex flex-col">
            ...
            <input
              ...
              className=" border-2 border-purple-900/70 px-3 py-4 rounded-md mt-3 shadow-md shadow-purple-800/50"
            />
          </div>
          <div className="flex flex-col">
          ...
          <div className="flex flex-col">
            ...
            <textarea
              cols={5}
              className="resize-none border-2 border-purple-900/70 px-3 py-4 rounded-md mt-3 shadow-md shadow-purple-800/50"
