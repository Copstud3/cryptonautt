  ...
  return (
    <section className="px-5 md:px-20 md:h-[400px] max-sm:mb-[80px] flex flex-col md:flex-row justify-between">
      ...
      <div className="max-sm:mt-15" data-aos="fade-left">
        ...
        <ul className="mt-8 list-disc pl-5 md:pl-10 font-inter md:text-lg">
          <li>
            <span className="font-bold">Community Platforms:</span> Discord,
            Telegram, Reddit
          </li>
          <li>
            <span className="font-bold">Social Media:</span> Twitter, Instagram,
            TikTokt
          </li>
          <li>
            <span className="font-bold">Analytics:</span> Google Analytics,
            Hootsuite Insights
          </li>
          <li>
            <span className="font-bold">Documentation:</span> Docs,Google sheet,
            Excel,Gitbook
          </li>
        </ul>
      </div>
